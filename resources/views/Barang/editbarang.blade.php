...
<head>
    <meta charset="UTF-8">
    <title>Edit barang | SISFO SARPRAS</title>
        ...
        <div class="content">
            ...
            <div class="form-container">
                <form method="POST" action="{{ route('barang.update', $barang->id) }}">
                    ...
                    <input type="text" id="name" name="name" value="{{ old('name', $barang->name) }}" required>

                    <label for="email">Email barang</label>
                    <input type="email" id="email" name="email" value="{{ old('email', $barang->email) }}" required>
